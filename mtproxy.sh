...
Download_mtproxy(){
	mkdir '/tmp/mtproxy'
	cd '/tmp/mtproxy'
	# wget -N --no-check-certificate "https://github.com/boji6681/MTProxy/archive/master.zip"
	git clone https://github.com/boji6681/MTProxy.git
...
if [[ "${action}" == "monitor" ]]; then
	...
	echo && echo -e "┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃   MTProxy  一键管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}　 ┃
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃   机场搭建 ❤ 机场托管 ❤ 技术支持 　┃ 
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
